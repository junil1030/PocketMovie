...
struct LoopingStack<Content: View>: View {
    ...
    var body: some View {
        // Starting with iOS 18 we can extract Subview collection from a view content with the help of Gruop
...
extension SubviewsCollection {
    // Now, to push cards behind when it's swiped and to make it appear as if it's looping, we cna actually rotate the array to achieve that
    ...
    func rotateFromLeft(by: Int) -> [SubviewsCollection.Element] {
        ...
        // If a array give [1, 2, 3, 4, 5] and steps 2, the result will be [3, 4, 5, 1, 2]
